...
export default function MatrixHero() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="hero-section-inner relative flex flex-col justify-between min-h-[460px] z-20 bg-black/40 py-8 px-4 lg:px-[72px]" style={{ backdropFilter: "blur(0.5px)" }}>
        ...
        <div className="hero-title-block w-full my-10 space-y-5 text-center lg:text-left">
          ...
          >
            ...
            <span className="block min-[2268px]:inline"> СОЛНЕЧНО</span>
          </h1>
        ...
        <div className="hero-btn-block w-full">
          <Link href="/initialize" className="block w-full lg:max-w-md">
